...
low = 1000
filtered_ft_data[0][np.where(frequencies < low)] = 0
filtered_ft_data[1][np.where(frequencies < low)] = 0

# high = 10000
# filtered_ft_data[0][np.where(frequencies > high)] = 0
# filtered_ft_data[1][np.where(frequencies > high)] = 0
